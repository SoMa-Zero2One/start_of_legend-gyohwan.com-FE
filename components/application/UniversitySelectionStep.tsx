      ...
      <div className="px-[20px] pt-[24px] pb-[100px]">
        ...
        <div className="mb-[24px] flex items-center justify-between gap-[12px]">
          ...
          <button
            ...
            className="flex flex-shrink-0 cursor-pointer items-center gap-[6px] rounded-[8px] bg-blue-50 px-[12px] py-[8px] transition-colors hover:bg-blue-100"
          >
            <SearchIcon size={18} className="text-primary-blue" />
            <span className="caption-1 text-primary-blue font-semibold">한번에 선택하기</span>
          </button>
        </div>
