    ...
    <div className="flex min-h-screen flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-[20px] py-[30px]">
        <div className="prose prose-sm max-w-none">
          <p className="mb-6">
            이 약관은 교환닷컴(이하 &quot;회사&quot;라 한다)이 가입절차를 거친 회원과, 거치지 않은 비회원 모두 회사에서
            제공하는 서비스(이하 &quot;서비스&quot;라 한다)를 이용함에 있어 개인정보를 어떻게
            수집·보관·이용·파기하는지에 대해 정보를 담은 방침입니다. 회사는 이용자의 권리 보호를 위해
            &quot;개인정보보호법&quot; 제30조에 따라 다음과 같이 개인정보처리방침을 공개합니다. 본 개인정보처리방침에서
            정의하지 않은 용어의 정의는 회사의 서비스 이용약관을 따릅니다.
          </p>

          <h2 className="mb-4 text-xl font-bold">1. 수집하는 개인정보의 항목</h2>
          <p className="mb-2">회사는 서비스 제공을 위해 아래와 같은 최소한의 개인정보를 수집·처리합니다.</p>

          <h3 className="mb-2 text-lg font-semibold">1) 회원가입 시 수집되는 개인정보</h3>
          <ul className="mb-4 list-disc space-y-2 pl-6">
            <li>
              자체 가입(이메일/비밀번호 방식) : 이메일 주소, 비밀번호(단방향 해시), 이메일 인증 여부, 닉네임(무작위 기본
              부여)
            </li>
            <li>
          ...
          <h3 className="mb-2 text-lg font-semibold">2) 기능별 별도로 수집되는 개인정보</h3>

          <h4 className="mb-2 font-semibold">가. 학교 인증 시 수집</h4>
          ...
          <h4 className="mb-2 font-semibold">나. 경쟁률·성적 공유 기능 이용 시 수집</h4>
          <ul className="mb-4 list-disc space-y-1 pl-6">
          ...
          <p className="mb-4">
            ※ 지원기간 종료 이후에는 닉네임 등 개인 식별 가능한 표지를 삭제·비식별화하고, 성적·가산점 등의 데이터는 통계
            작성, 분석, 서비스 고도화, 모델 학습, 리포트 발간 등의 목적으로 보관∙활용될 수 있습니다. 이 비식별 데이터는
            회원 탈퇴 이후에도 계속 보관될 수 있습니다.
          </p>

          <h4 className="mb-2 font-semibold">다. 커뮤니티 이용 시 수집</h4>
          <ul className="mb-4 list-disc space-y-1 pl-6">
            <li>회원 글/댓글: 닉네임(또는 익명 선택 시 익명 표기), 게시글/댓글/이미지 등 첨부, 신고/차단 기록</li>
            <li>
          ...
          <h4 className="mb-2 font-semibold">라. 자동으로 수집되는 정보(로그)</h4>
          <ul className="mb-4 list-disc space-y-1 pl-6">
          ...
          <p className="mb-4">
            ※ 자동 수집된 로그 정보는 다른 정보와 결합되는지 여부와 처리 형태에 따라 &apos;개인정보&apos;일 수도 있고
            아닐 수도 있습니다. 회사는 이를 서비스 제공, 품질 개선, 부정이용 방지, 보안 목적 범위에서 처리합니다.
          </p>

          <h4 className="mb-2 font-semibold">마. 문의/신고 처리 시 수집 (필요 시)</h4>
          ...
          <h2 className="mb-4 text-xl font-bold">2. 개인정보의 처리 목적</h2>
          ...
          <ol className="mb-6 list-decimal space-y-1 pl-6">
            ...
            <li>커뮤니티 운영(닉네임 또는 익명으로 글/댓글 게시, 비회원 게시글 비밀번호 기반 수정/삭제 등)</li>
            <li>교환학생 경쟁률 비교 및 성적 공유 등 핵심 서비스 제공</li>
            <li>서비스 품질 향상, 신규 기능 개발, 통계·분석, 맞춤형 기능 또는 안내 제공</li>
            <li>서비스 부정 이용·약관 위반 행위 탐지 및 차단(다중계정 방지, 비정상적 인증 시도 등)</li>
            <li>공지·문의 응대, 분쟁 처리, 법령상 의무 이행</li>
            <li>
              지원기간 종료 후 비식별화된 데이터(성적 등)를 활용한 통계 작성, 리포트 발간, 시장 분석, 모델 학습, 서비스
              고도화, 상업적 활용
          ...
          <p className="mb-4">
            회사는 법령에서 정한 기간 또는 이용자로부터 동의 받은 기간 내에서 개인정보를 보유·이용하며, 기간이 지나면
            지체 없이 파기합니다.
          </p>
          <p className="mb-4">
          ...
          <h3 className="mb-2 text-lg font-semibold">1. 계정 정보(이메일, 소셜 ID 등)</h3>
          <ul className="mb-4 list-disc space-y-1 pl-6">
            <li>
              회원 탈퇴 시 지체 없이 파기
          ...
          <h3 className="mb-2 text-lg font-semibold">2. 학교 인증 기록</h3>
          <ul className="mb-4 list-disc space-y-1 pl-6">
            <li>
              학교 인증 내역은 계정 유지 기간 동안 보유
              <br />- 탈퇴 시 원칙적으로 파기하나, 부정 이용(중복 인증 등) 방지 목적으로 위 28일 보관 정책이 적용됩니다.
            </li>
          </ul>

          <h3 className="mb-2 text-lg font-semibold">3. 커뮤니티 게시물/댓글</h3>
          <ul className="mb-4 list-disc space-y-1 pl-6">
            <li>이용자가 작성한 게시물·댓글은 서비스의 특성상 탈퇴 후에도 남을 수 있습니다(백업/캐시 포함).</li>
            <li>회사는 가능한 범위 내에서 닉네임을 비식별·가명화하거나 삭제할 수 있도록 합니다.</li>
            <li>비회원 게시글 비밀번호(해시)는 해당 게시물 유지기간 동안 보관됩니다.</li>
          </ul>

          <h3 className="mb-2 text-lg font-semibold">4. 경쟁률·성적 공유 데이터(학점, 어학성적, 가산점, 지원 학교)</h3>
          <ul className="mb-4 list-disc space-y-1 pl-6">
            <li>서비스상 표시되는 기간(예: 지원기간) 동안에는 닉네임(가명 포함)과 함께 노출될 수 있습니다.</li>
            <li>해당 기간 종료 후에는 닉네임 등 식별자를 삭제하고 비식별 데이터로 전환합니다.</li>
            <li>
              비식별 데이터는 회원 탈퇴 이후에도 통계·연구·리포트 발간·서비스 고도화·상업적 활용 목적으로 계속 보관할 수
              있습니다.
            </li>
            <li>
          ...
          <h3 className="mb-2 text-lg font-semibold">5. 로그 기록, 보안 관련 기록(IP, 접속 기록 등)</h3>
          <ul className="mb-4 list-disc space-y-1 pl-6">
            <li>보안, 서비스 안정화, 분쟁 대응을 위해 최대 6개월 보관 후 파기합니다.</li>
            <li>관련 법령에서 더 긴 기간을 요구하는 경우 그에 따를 수 있습니다.</li>
          </ul>

          <h3 className="mb-2 text-lg font-semibold">6. 고객 문의/신고 처리 기록</h3>
          <ul className="mb-4 list-disc space-y-1 pl-6">
            <li>
          ...
          <h2 className="mb-4 text-xl font-bold">4. 쿠키 등 자동 수집 기술에 관한 안내</h2>
          <p className="mb-2">
            회사는 이용자 맞춤형 서비스 제공, 보안, 접속 유지, 통계 분석 등을 위해 쿠키(cookie) 및 유사 기술을 사용할 수
            있습니다.
          </p>
          <ul className="mb-6 list-disc space-y-1 pl-6">
          ...
          <h2 className="mb-4 text-xl font-bold">5. 개인정보의 제3자 제공</h2>
          <p className="mb-2">
          ...
          <h2 className="mb-4 text-xl font-bold">6. 개인정보 처리의 위탁</h2>
          <p className="mb-4">
            회사는 안정적인 서비스 제공, 시스템 운영, 보안 및 알림 발송 등을 위해 일부 업무를 외부 업체에 위탁할 수
            있습니다. 위탁 시 「개인정보 보호법」에 따라 안전한 처리를 위한 계약을 체결하고 관리·감독합니다.
          </p>
          <p className="mb-6">변동사항 발생 시 공지사항 또는 개인정보처리방침을 통해 고지합니다.</p>

          <h2 className="mb-4 text-xl font-bold">7. 개인정보 자동 수집 장치를 통한 제3자의 정보 수집</h2>
          <h3 className="mb-2 text-lg font-semibold">1. 정보주체에게 수집하는 방법과 관련 내용은 다음과 같습니다.</h3>
          ...
          <p className="mb-4">
            사용자에게 맞춤 서비스와 편의를 제공하기 위해 이용정보를 저장하고 활용하는 &quot;쿠키(cookie)&quot;를 수집할
            수 있습니다.
          </p>
          ...
          <h4 className="mb-2 font-semibold">웹 브라우저</h4>
          <ul className="mb-4 list-disc space-y-1 pl-6">
          ...
          <h4 className="mb-2 font-semibold">모바일</h4>
          <ul className="mb-6 list-disc space-y-1 pl-6">
            <li>iOS : 아이폰 설정 → 개인정보보호 선택 → 광고선택 → 광고추적 제한 해제 (OS 버전 별 상이할 수 있음)</li>
            <li>
              Android : 구글 설정 → 계정 → 계정 선택 → 광고 선택 → 광고 맞춤설정 선택 해제 (OS 버전 별 상이할 수 있음)
            </li>
          </ul>

          <h2 className="mb-4 text-xl font-bold">8. 이용자의 권리와 행사 방법</h2>
          ...
          <h2 className="mb-4 text-xl font-bold">9. 만 14세 미만 아동의 개인정보 처리</h2>
          <p className="mb-4">
            회사는 만 14세 미만 이용자의 회원가입을 금지하며, 가입 과정에서 만 14세 이상임을 확인합니다.
          </p>
          <p className="mb-6">회사는 원칙적으로 만 14세 미만 아동의 개인정보를 수집·처리하지 않습니다.</p>

          <h2 className="mb-4 text-xl font-bold">10. 개인정보의 안전성 확보 조치</h2>
          ...
          <h2 className="mb-4 text-xl font-bold">11. 광고성 정보 및 맞춤형 안내</h2>
          <ol className="mb-6 list-decimal space-y-2 pl-6">
            <li>
          ...
          <h2 className="mb-4 text-xl font-bold">12. 개인정보 보호 책임자 및 연락처</h2>
          <p className="mb-2">
            회사는 개인정보 처리에 관한 업무를 총괄하여 책임지고, 이용자의 불만 처리 및 피해 구제 등을 위해 개인정보
            보호책임자를 지정합니다.
          </p>
          ...
          <p className="mb-2">
            이용자는 위 연락처를 통해 개인정보 열람·정정·삭제·처리정지 요청, 불만처리, 피해구제 등을 문의할 수 있습니다.
          </p>
          ...
          <h2 className="mb-4 text-xl font-bold">13. 고지의 의무</h2>
          <ol className="mb-6 list-decimal space-y-2 pl-6">
            <li>회사는 관련 법령 또는 서비스 내용의 변경에 따라 본 개인정보처리방침을 개정할 수 있습니다.</li>
            <li>
