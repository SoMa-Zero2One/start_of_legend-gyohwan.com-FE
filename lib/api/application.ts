 ...
 */
export const submitApplication = async (seasonId: number, data: SubmitApplicationRequest): Promise<void> => {
 ...
 * @throws {Error} API 호출 실패 시
 */
export const updateApplication = async (seasonId: number, data: UpdateApplicationRequest): Promise<void> => {
  const backendUrl = getBackendUrl();
